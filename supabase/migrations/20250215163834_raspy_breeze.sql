...
DROP POLICY IF EXISTS "Anyone can view published analyses" ON market_analysis;
DROP POLICY IF EXISTS "Admin or owner can manage analyses" ON market_analysis;
DROP POLICY IF EXISTS "Users can create analyses" ON market_analysis;
DROP POLICY IF EXISTS "Users can update their own analyses" ON market_analysis;
...
GRANT USAGE ON SEQUENCE market_analysis_id_seq TO authenticated;